document.addEventListener("DOMContentLoaded", function() {
    ...
    function fetchAuthenticationLoginData(username, password) {
        const authUrl = 'https://ap-southeast-1.aws.services.cloud.mongodb.com/api/client/v2.0/app/data-btthb/auth/providers/custom-function/login';
        ...
        fetch(authUrl, {
            ...
            .then(data => {
                ...
                const accessToken = JSON.parse(JSON.stringify(data)).access_token;
